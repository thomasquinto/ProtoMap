    ...
    private void switchTab(int tabId) {
        ...
        switch (tabId) {
            case R.id.tab_people:
                ...
                statusBarColor = R.color.main_blueberry_500;
                break;
            case R.id.tab_places:
                tab2.setVisibility(View.VISIBLE);
                statusBarColor = R.color.main_kale_500;
                break;
            case R.id.tab_safety:
                tab3.setVisibility(View.VISIBLE);
                statusBarColor = R.color.main_fig_500;
                break;
            case R.id.tab_profile:
                tab4.setVisibility(View.VISIBLE);
                statusBarColor = R.color.primary_main_grape_500;
                break;
        }
